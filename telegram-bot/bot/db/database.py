...
class Database:
    ...
    async def _init_tables(cls):
        ...
        async with cls._pool.acquire() as conn:
            ...
            # Game settings table (simplified - no value_type)
            await conn.execute("""
...
async def _create_indexes(cls, conn):
    ...
    await conn.execute("""
        ...
        ON pending_withdrawals(status, requested_at) 
